...
public class Session {
	...
	/**
	 * Returns a iterator of all added contestants that can be iterated. The
	 * contestants will be in no particular order.
	 */
	 ...
	 * @deprecated Use {@link #getContestants()} instead.
	 */
	...
	public int getRacePosition(Contestant c) {
		...
		//TODO refactor this to use Comparable<Contestant>
