...
import com.dennisbijlsma.xmlserver.MessageQueue;
import com.dennisbijlsma.xmlserver.SocketManager;
import com.dennisbijlsma.xmlserver.XMLMessage;
import com.dennisbijlsma.xmlserver.XMLServer;
...
public class Multiplayer implements ConnectionListener {
	...
	private Multiplayer() {
		...
		manager=new SocketManager(Settings.MULTIPLAYER_PORT);
