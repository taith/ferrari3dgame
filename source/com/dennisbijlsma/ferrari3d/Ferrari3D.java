 ...
 */
public final class Ferrari3D extends GameCore {
	...
	public static final Version VERSION = new Version("2.4.1");
	...
	private void initApplicationMenu() {
		MacSupport.addApplicationMenuListener(new ApplicationMenuListener() {
			public void about() {
				Popups.message(null, Settings.getInstance().getText("menu.about", VERSION.toString()));
			}
		...
		MacSupport.setApplicationPreferencesEnabled(false);
	}
