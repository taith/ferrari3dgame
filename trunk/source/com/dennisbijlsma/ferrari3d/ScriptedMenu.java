...
public class ScriptedMenu extends JPanel {
	...
	protected void createMenu(String id) {
		...
		String file=DataLoader.loadTextFile(Resources.getResource(SCRIPT_LOCATION+id+".bsh"),SCRIPT_ENCODING);
	...
	private void showSystemInfo() {
		...
		system+=settings.getText("menu.systeminfo.locale")+" "+Resources.getDefaultLocale().getDisplayLanguage()+"\n";
		system+="\n";
