...
public class MenuScreen extends JPanel {
	...
	private ArrayList<MenuPanel> panels;
	...
	private static final Image BACKGROUND_IMAGE=Utils.loadImage("data/graphics/menu_background.jpg");
	...
	protected void paintComponent(Graphics g) {
		...
		Utils.drawAlignedString(g2,title,getWidth()/2+2,HEADER-18,'c');
		g2.setColor(TITLE_COLOR);
		Utils.drawAlignedString(g2,title,getWidth()/2,HEADER-20,'c');
