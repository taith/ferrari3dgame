...
public class UIMenuOption extends UIMenuWidget {
	...
	public UIMenuOption(String label, Object value, boolean useEditButton) {
	...
	private void fireActionListeners(UIWidget source) {
		for (ActionListener i : listeners) {
			i.actionPerformed(source);
		}
	}
