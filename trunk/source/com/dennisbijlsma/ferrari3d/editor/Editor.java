...
import com.dennisbijlsma.core3d.scene.TextureException;
...
import com.dennisbijlsma.util.swing.Action;
import com.dennisbijlsma.util.swing.ActionForwarder;
...
public final class Editor {
	...
	public Editor() {
		...
		JScrollPane infoPane=carInfoList.createScrollPane(100, 100);
	...
	public void textsItemClicked() { 
		...
		JScrollPane textsPane = textsPanel.createScrollPane(600, 200);
	...
	public void addNodeClicked() {
		...
		if (type.equals("Billboard")) {
			...
			if (!TextureException.isPowerOfTwo(texture)) {
				Popups.message(frame, settings.getText("editor.message.invalidtexture", billboardFile));
				return;
			}
			
			node = new Billboard(name, 1f, 1f, texture); //TODO support other billboard dimensions
