...
public class Preview extends JPanel {
	...
	protected void init() {
		...
		Display display=renderer.createDisplay(Display.DisplayType.PANEL,500,500);
	
		SwingGame game=new SwingGame(display) {
			public void initGame() {
				Camera camera=RenderSystem.getRenderer().createCamera(getDisplay());			
