...
public final class Utils {
	...
	/**
	 * Sets a vector to the relative coordinate system between two other vectors.
	 */
	public static void relativeTo(Vector3D out, Vector3D v1, Vector3D v2, float angle) {
		v1.rotateY(angle);
		v2.rotateY(angle);
		out.setVector(v2.getX() - v1.getX(), v2.getY() - v1.getY(), v2.getZ() - v1.getZ());
	}
