...
public class Player extends Contestant {
	 ...
	 * @param controlset The control keys, see {@code Settings.getControlSet()}.
	 */
	
	public Player(String id, Session session, CarPhysics physics, Car car, Circuit circuit, 
			Controller controller, int[] controlset) {
